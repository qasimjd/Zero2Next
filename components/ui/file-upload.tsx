  ...
  return (
    <div className="w-full mx-auto">
      <div className="my-4">
        {(status === "idle" || status === "dragging") && (
          <div
            className={`flex flex-col items-center justify-center p-8 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${
              status === "dragging"
                ...
                : "border-black-200 hover:border-primary hover:bg-primary/5"
            }`}
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Only image files (Max {formatBytes(maxFileSize)})
            </p>
            <input
              ref={fileInputRef}
              type="file"
        ...
        {file && status === "success" && previewUrl && (
          <div className="mt-4 flex flex-col items-center gap-2">
            ...
            <div className="flex gap-2">
              {/* <Button onClick={triggerFileInput} size="sm">Replace</Button> */}
              <Button onClick={handleRemoveFile} variant="outline" size="sm">Remove</Button>
            </div>
          </div>
        )}
      </div>
